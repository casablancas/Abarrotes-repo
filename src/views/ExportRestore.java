    ...
    public boolean backupDataWithDatabase(String dumpExePath, String host, String user, String password, String database, String backupPath) {
        ...
        try {
            ...
            if (password != "") {
                ...
                batchCommand = dumpExePath + " -h " + host + " -u " + user + " --password=" + password + " --add-drop-database -B " + database + " -r \"" + backupPath + ""  + "\"";
            } else if (password == ""){
                batchCommand = dumpExePath + " -h " + host + " -u " + user + " --add-drop-database -B " + database + " -r \"" + backupPath + "" + "\"";
            }
            ...
            if (processComplete == 0) {
                ...
                JOptionPane.showMessageDialog(null, "Se ha exportado correctamente la base de datos.");
//                log.info(");
            } else {
                status = false;
                System.out.println("Could not create the backup for with DB " + database + " in " + host + ":");
                JOptionPane.showMessageDialog(null, "Algo salió mal. No se pudo exportar la base de datos.");
...
//        backupDB();
        ...
        System.out.println("Guarda: " + guarda+" PathArchivo: " +pathArchivo);
        
        String name = guarda.getName();
        
        System.out.println("Nombre del archivo: " +guarda.getName());
        ...
        //String path_and_name = pathArchivo.replaceAll("\\", "/");
        
        //System.out.println("Nuevo path: "+path_and_name);
...
//      backupDataWithDatabase("C:\\xampp\\mysql\\bin\\mysqldump", "db4free.net", "oswaldo", "oswaldohuerta", "abarrotera", "C:/Users/Alex/Desktop/jiji.sql");
        backupDataWithDatabase("C:\\xampp\\mysql\\bin\\mysqldump", "localhost", "root", "", "abarrotera", "C:/Users/"+username+"/Desktop/"+name+".sql");
